...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def setUp(self):
        ...
        test_book = Book.objects.create(title='Book Title', summary = 'My book summary', isbn='ABCDEFG', author=test_author, language='e')
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def setUp(self):
        ...
        test_user2 = User.objects.create_user(username='testuser2', password='12345')
        test_user2.save()
        # Permission.objects.create.create("can_mark_returned")
